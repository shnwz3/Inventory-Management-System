...
function Inventory() {
  ...
  const fetchSearchData = () => {
    fetch(`https://inventrx-back.vercel.app/api/product/search?searchTerm=${searchTerm}`)
      .then((response) => response.json())
      .then((data) => {
        setAllProducts(data);
      })
  ...
  const deleteItem = (id) => {
    ...
    console.log(`https://inventrx-back.vercel.app/api/product/delete/${id}`);
    fetch(`https://inventrx-back.vercel.app/api/product/delete/${id}`)
      .then((response) => response.json())
      .then((data) => {
